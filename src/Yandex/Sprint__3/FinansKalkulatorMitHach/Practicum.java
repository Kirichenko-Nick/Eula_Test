...
public class Practicum {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command == 1) {
                ...
                String maxKategorieName = expensesManager.getMaxCategoryName();
                System.out.printf("В категории %s вы потратили больше всего.\n", maxKategorieName);
            } else if (command == 0) {
 ...
 /* maxExpense = expensesByCategories.get(category)
                    .stream()
                    .max(Double::compare)
                    .orElse(0.0);*/