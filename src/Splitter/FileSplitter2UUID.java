...
public class FileSplitter2UUID {
        ...
        try (FileInputStream fis = new FileInputStream(inputFile);
            ...
            while ((bytesRead = bis.read(buffer)) != -1) {
                ...
                String outputFilePath = inputFile.getParent() + File.separator +
                        fileNameWithoutExtension + "_part_" + chunkNumber + "_crc_" + crcValue + "_id_" + uuid + ".bin";
                try (FileOutputStream fos = new FileOutputStream(outputFilePath)) {
                    fos.write(buffer, 0, bytesRead);
                }

                System.out.println("Часть " + chunkNumber + " сохранена. CRC32: " + crcValue + " Id: " + uuid);
                chunkNumber++;
            }
        }
    }
